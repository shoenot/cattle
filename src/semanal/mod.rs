...
fn walk_program<V: Visitor + ?Sized>(v: &mut V, program: &mut Program) -> Result<(), SemanticError> {
...
fn walk_declaration<V: Visitor + ?Sized>(v: &mut V, declaration: &mut Decl) -> Result<(), SemanticError> {
    match declaration {
...
fn walk_block<V: Visitor + ?Sized>(v: &mut V, block: &mut Block) -> Result<(), SemanticError> {
...
fn walk_var_decl<V: Visitor + ?Sized>(v: &mut V, var: &mut VarDeclaration) -> Result<(), SemanticError> {
...
fn walk_func_decl<V: Visitor + ?Sized>(v: &mut V, func: &mut FuncDeclaration) -> Result<(), SemanticError> {
...
fn walk_statement<V: Visitor + ?Sized>(v: &mut V, statement: &mut Statement) -> Result<(), SemanticError> {
    match statement {
...
fn walk_expression<V: Visitor + ?Sized>(v: &mut V, expression: &mut Expression) -> Result<(), SemanticError> {
    match expression {
